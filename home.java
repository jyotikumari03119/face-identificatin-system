...
jtp.setBackground(Color.PURPLE);
jtp.setForeground(Color.PURPLE);
...
Font f2=new Font("Palatino Linotype",Font.BOLD,20);
 ...
 l3.setBackground(Color.PURPLE);
 l3.setForeground(Color.PURPLE);
l3.setFont(f);
 con.add(l3);
...
b1.setIcon(new ImageIcon("images\\img.jpg"));
 ...
 b2=new JButton();
b2.setIcon(new ImageIcon("images\\1.jpg"));
...
lbl_picHelp.setIcon(new ImageIcon("images//helppic.jpg"));
add(lbl_picHelp);
